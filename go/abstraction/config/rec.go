...
func encOrigin(out []byte, v *Origin, depth int) []byte {
	out = append(out, '{')
	out = append(out, '\n')
	out = pad(out, depth+1)
	out = esc(out, "rung")
...
func encOrigins(out []byte, v *Origins, depth int) []byte {
	out = append(out, '{')
	out = append(out, '\n')
	out = pad(out, depth+1)
	out = esc(out, "nas_store")
	out = append(out, ':', ' ')
	out = encOrigin(out, &v.NasStore, depth+1)
	out = append(out, ',')
	out = append(out, '\n')
	out = pad(out, depth+1)
	out = esc(out, "store")
	out = append(out, ':', ' ')
	out = encOrigin(out, &v.Store, depth+1)
	out = append(out, ',')
	out = append(out, '\n')
	out = pad(out, depth+1)
	out = esc(out, "log_sink")
	out = append(out, ':', ' ')
	out = encOrigin(out, &v.LogSink, depth+1)
	out = append(out, ',')
	out = append(out, '\n')
	out = pad(out, depth+1)
	out = esc(out, "log_service")
	out = append(out, ':', ' ')
	out = encOrigin(out, &v.LogService, depth+1)
	out = append(out, ',')
	out = append(out, '\n')
	out = pad(out, depth+1)
	out = esc(out, "off")
	out = append(out, ':', ' ')
	out = encOrigin(out, &v.Off, depth+1)
	out = append(out, '\n')
	out = pad(out, depth)
	return append(out, '}')
}

func encSnapshot(out []byte, v *Snapshot, depth int) []byte {
	out = append(out, '{')
	out = append(out, '\n')
	out = pad(out, depth+1)
	out = esc(out, "nas_store")
	...
	out = esc(out, "origins")
	out = append(out, ':', ' ')
	out = encOrigins(out, &v.Origins, depth+1)
	out = append(out, ',')
	out = append(out, '\n')
	out = pad(out, depth+1)
	out = esc(out, "stamp")
...
func Encode(v *Snapshot) []byte {
	return append(encSnapshot(nil, v, 0), '\n')
}
...
func (r *reader) decodeRunOverrides() (*RunOverrides, error) {
	if r.at() != '{' {
		return nil, r.refuse("wrong_type")
	}
	if err := r.enter(); err != nil {
...
func (r *reader) decodeOrigin() (*Origin, error) {
	if r.at() != '{' {
		return nil, r.refuse("wrong_type")
	}
	if err := r.enter(); err != nil {
...
func (r *reader) decodeOrigins() (*Origins, error) {
	if r.at() != '{' {
		return nil, r.refuse("wrong_type")
	}
	if err := r.enter(); err != nil {
...
func (r *reader) decodeSnapshot() (*Snapshot, error) {
	if r.at() != '{' {
		return nil, r.refuse("wrong_type")
	}
	if err := r.enter(); err != nil {
...
type ConfigReaderClient struct{ transport ConfigReaderTransport }

func NewConfigReaderClient(t ConfigReaderTransport) *ConfigReaderClient {
	return &ConfigReaderClient{transport: t}
}
...
func (d *ConfigReaderDispatcher) ExchangeFrame(frame []byte) ([]byte, error) {
	v, err := servicePayload(frame)
	if err != nil {
		return nil, err
	}
	...
	case "Read":
		...
		r.ws()
		args, err := r.decodeOAConfigReaderReadArguments()
		if err != nil {
...
func (d *ConfigReaderDispatcher) invokeRead(args *OAConfigReaderReadArguments) (payload Raw, err error) {
	...
	var result Snapshot
	result, err = d.Handler.Read(args.Overrides)
	if err != nil {
		return
	}
